    ...
    function simple_breadcrumb_case($der_post) {
        ...
        if (is_author()) {
           ...
           global $wp_query;
            ...
            return __('Author', 'biznez-lite') . ': ' . $curauth->display_name;
        ...
        if (is_tag()) {
            ...
            return __('Tag', 'biznez-lite') . ': ' . single_tag_title('', false);
        ...
        if (is_search()) {
            ...
            return __('Search', 'biznez-lite');

        }

		if (is_404()) {

            return __('Error 404', 'biznez-lite');
