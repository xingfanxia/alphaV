...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __('No Repeat', 'biznez-lite'),
		'repeat-x'  => __('Repeat Horizontally', 'biznez-lite'),
		'repeat-y'  => __('Repeat Vertically', 'biznez-lite'),
		'repeat'    => __('Repeat All', 'biznez-lite'),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __('Top Left', 'biznez-lite'),
		'top center'    => __('Top Center', 'biznez-lite'),
		'top right'     => __('Top Right', 'biznez-lite'),
		'center left'   => __('Middle Left', 'biznez-lite'),
		'center center' => __('Middle Center', 'biznez-lite'),
		'center right'  => __('Middle Right', 'biznez-lite'),
		'bottom left'   => __('Bottom Left', 'biznez-lite'),
		'bottom center' => __('Bottom Center', 'biznez-lite'),
		'bottom right'  => __('Bottom Right', 'biznez-lite')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __('Scroll Normally', 'biznez-lite'),
		'fixed'  => __('Fixed in Place', 'biznez-lite')
		);
...
function of_recognized_font_styles() {
	$default = array(
		...
		'italic'      => __('Italic', 'biznez-lite'),
		'bold'        => __('Bold', 'biznez-lite'),
		'bold italic' => __('Bold Italic', 'biznez-lite')
		);
