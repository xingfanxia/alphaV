	...
	<div class="container_24 clearfix">
	  ...
	  <div class="pagetitle-wrap grid_24 clearfix">
			...
			<?php if ( is_day() ) : ?>
							...
							<?php printf( __( 'Daily Archives: <span>%s</span>', 'biznez-lite' ), get_the_date() ); ?>

			<?php elseif ( is_month() ) : ?>

							<?php printf( __( 'Monthly Archives: <span>%s</span>', 'biznez-lite' ), get_the_date('F Y') ); ?>

			<?php elseif ( is_year() ) : ?>

							<?php printf( __( 'Yearly Archives: <span>%s</span>', 'biznez-lite' ), get_the_date('Y') ); ?>

			<?php else : ?>

							<?php _e( 'Blog Archives', 'biznez-lite' ); ?>
