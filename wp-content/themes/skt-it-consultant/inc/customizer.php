...
function skt_itconsultant_customize_register( $wp_customize ) {
	...
	$wp_customize->add_section('logo_sec',array(
			...
			'description'	=> __('Logo uplaod option available only in <strong><a href="'.esc_url(SKT_PRO_THEME_URL).'" target="_blank">PRO Version</a></strong>','itconsultant'),
			'priority'		=> 1
	));
	...
	$wp_customize->add_control(
		new WP_Customize_Color_Control(
			...
			array(
				...
				'description'	=> __('More color options available in <strong><a href="'.esc_url(SKT_PRO_THEME_URL).'" target="_blank">PRO Version</a></strong>','itconsultant'),
	...
	$wp_customize->add_section('slider_sec',array(
			...
			'description'	=> __('Add slider images here. More slider settings available in <strong><a href="'.esc_url(SKT_PRO_THEME_URL).'" target="_blank">PRO Version</a></strong>','itconsultant'),
			'priority'	=> null
	));
	...
	$wp_customize->add_section('homepagecontent_sec',array(
			...
			'description'	=>	__('Homepage sections available in <strong><a href="'.esc_url(SKT_PRO_THEME_URL).'" target="_blank">PRO Version</a></strong>'),		
	));
	...
	$wp_customize->add_section('typography',array(
			...
			'description'	=> __('Typography option available in <strong><a href="'.esc_url(SKT_PRO_THEME_URL).'" target="_blank">PRO Version</a></strong>','itconsultant'),
			'priority'	=> null
	));
	...
	$wp_customize->add_section('layout_sec',array(
			...
			'description'	=> __('Layout settings available in <strong><a href="'.esc_url(SKT_PRO_THEME_URL).'" target="_blank">PRO Version</a></strong>','itconsultant'),
			'priority'	=> null
	));
	...
	$wp_customize->add_section(
        ...
        array(
            ...
            'priority' => null,
            'description' => __('For documentation and support check this link : <a href="'.SKT_THEME_DOC.'" target="_blank">IT Consultant Documentation</a>','itconsultant'),
        )
    );  
