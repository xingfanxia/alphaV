...
function of_recognized_background_repeat() {
	...
	$default = array(
		'no-repeat' => __( 'No Repeat', 'skt-kraft' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'skt-kraft' ),
		'repeat-y'  => __( 'Repeat Vertically', 'skt-kraft' ),
		'repeat'    => __( 'Repeat All', 'skt-kraft' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'skt-kraft' ),
		'top center'    => __( 'Top Center', 'skt-kraft' ),
		'top right'     => __( 'Top Right', 'skt-kraft' ),
		'center left'   => __( 'Middle Left', 'skt-kraft' ),
		'center center' => __( 'Middle Center', 'skt-kraft' ),
		'center right'  => __( 'Middle Right', 'skt-kraft' ),
		'bottom left'   => __( 'Bottom Left', 'skt-kraft' ),
		'bottom center' => __( 'Bottom Center', 'skt-kraft' ),
		'bottom right'  => __( 'Bottom Right', 'skt-kraft')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'skt-kraft' ),
		'fixed'  => __( 'Fixed in Place', 'skt-kraft')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'skt-kraft' ),
		'italic'      => __( 'Italic', 'skt-kraft' ),
		'bold'        => __( 'Bold', 'skt-kraft' ),
		'bold italic' => __( 'Bold Italic', 'skt-kraft' )
		);
