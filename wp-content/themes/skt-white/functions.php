...
function skt_white_custom_head_codes() { 
	if ( function_exists('of_get_option') ){
		...
		if( of_get_option('colorscheme',true) != ''){
			echo ".our-projects img:hover{ background:".of_get_option('colorscheme','#00a8ff')."; float:left; background:url(".get_template_directory_uri()."/images/camera-icon.png) 50% 50% no-repeat ".of_get_option('colorscheme','#00a8ff')."; }";
		}
		echo "</style>";
	}
}
