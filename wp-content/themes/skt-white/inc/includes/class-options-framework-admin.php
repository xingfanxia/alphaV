...
class Options_Framework_Admin {
     ...
     */
	 function options_page() { ?>
        ...
        <div style="padding-top:10px;font-size:15px;"><a href="<?php echo esc_url(SKT_PRO_THEME_URL); ?>" target="_blank"><?php _e('Buy PRO version for only $39 with more features.','skt-corp'); ?></a></div>
